...
$(document).ready(function() {
	$("#btnList").val("닫기").attr("id","#btnMainList");
...
<div id="list">
	<div>
		<h1 style="margin-top: 0px;">자유게시판</h1>
	</div>
		<div>
	...
	<c:forEach items="${map.list }" var="dto">
		...
		<div style="width: 300px; float: left;">
			<a href="javascript:void(0)" onclick="sendBarData('./freeBoardDetail.ino?num=${dto.NUM }')" >${dto.TITLE }</a>
	...
	<div id="pageBlock">
		<c:if test="${map.pagingUt.curPage > 1 }">
			<a href="javascript:void(0)" onclick="sendBarData('./main.ino?curPage=1&searchType=${map.searchType}&searchTxt=${map.searchTxt}&beginDate=${map.beginDate}&endDate=${map.endDate}')"><button>첫페이지</button></a>
			<a href="javascript:void(0)" onclick="sendBarData('./main.ino?curPage=${map.pagingUt.curPage-1 }&searchType=${map.searchType}&searchTxt=${map.searchTxt}&beginDate=${map.beginDate}&endDate=${map.endDate}')"><button>이전</button></a>
		</c:if>
		...
		<c:choose>
			...
			<c:otherwise>
				<a href="javascript:void(0)" onclick="sendBarData('./main.ino?curPage=${num }&searchType=${map.searchType}&searchTxt=${map.searchTxt}&beginDate=${map.beginDate}&endDate=${map.endDate}')">${num}</a>
...
<%-- 			<a href="./main.ino?curPage=${map.pagingUt.totalPage }&searchType=${map.searchType}&searchTxt=${map.searchTxt}&beginDate=${map.beginDate}&endDate=${map.endDate}"><button>마지막페이지</button></a> --%>
			<a href="javascript:void(0)" onclick="sendBarData('./main.ino?curPage=${map.pagingUt.curPage+1 }&searchType=${map.searchType}&searchTxt=${map.searchTxt}&beginDate=${map.beginDate}&endDate=${map.endDate}')"><button>다음</button></a>
			<a href="javascript:void(0)" onclick="sendBarData('./main.ino?curPage=${map.pagingUt.totalPage }&searchType=${map.searchType}&searchTxt=${map.searchTxt}&beginDate=${map.beginDate}&endDate=${map.endDate}')"><button>마지막페이지</button></a>
		</c:if>

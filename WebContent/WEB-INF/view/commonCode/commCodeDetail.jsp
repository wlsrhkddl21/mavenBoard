...
function addInsertBox(){
	...
	if(index<3){
		...
		str += "<input type='text' id='mCode' name='mCode' value='${code}' style='margin-left: 5px;' readonly />"
		str += "<input type='text' id='dCode' name='dCode' style='margin-left: 25px;'/>"
		str += "<input type='text 'id='codeName' data-save='in' name='codeName' style='margin-left: 30px;'/>"
...
function test(){
	...
	if($("input[data-save=u]").length>0){
		
	}
	if($("input[data-save=d]").length>0){
		
	}
	if($("input[data-save=in]").length>0){
...
<h1 style="text-align: center;">디테일</h1>
	<div style="width:700px;" align="right">
		<input type="button" id="btnTest" onclick="test()" value="테스트"/>
